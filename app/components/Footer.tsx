...
const Footer = () => {
  return (
    <footer className="relative px-[24px] pt-[52px] pb-[38px] bg-[var(--light-black)] flex flex-col justify-center items-center gap-[48px] sm:px-[40px] sm:pt-[60px] sm:items-start sm:gap-[32px] lg:px-[165px] lg:pt-[75px]">
