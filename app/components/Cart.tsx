...
const Cart = () => {
  ...
  return (
    <>
      ...
      >
        <section
          className={`w-[calc(100vw-48px)] mx-[24px] mt-[28px] px-[28px] py-[31px] bg-[var(--white)] rounded-[8px] transition-[max-height] duration-500 ease-in-out flex flex-col ${isCartOpened ? "max-h-[750px]" : "max-h-0"} sm:absolute sm:top-[24px] sm:right-[40px] sm:m-0 sm:max-w-[377px] sm:px-[32px] lg:top-[32px] lg:right-[165px]`}
        >
          <div className="flex flex-row justify-between">
            ...
            {totalAmount > 0 && (
              <button
                type="button"
                className="text-[15px] leading-[var(--line-height-medium-15)] font-[var(--font-weight-medium)] text-[var(--black)]/50 underline cursor-pointer hover:text-[var(--black)]/75"
                onClick={clearCart}
              >
                Remove all
              </button>
